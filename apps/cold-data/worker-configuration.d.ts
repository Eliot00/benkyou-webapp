/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 88a707bd9da096708db3646117217888)
// Runtime types generated with workerd@1.20250705.0 2025-07-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		MONGO_DB_URI: string;
		REVIEW_LOGS_WORKFLOW: Workflow;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MONGO_DB_URI">> {}
}
